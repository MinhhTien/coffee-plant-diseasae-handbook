  ...
  return isLoading ? (
    ...
    <>
      <div className="mb-6 rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        <div className="flex flex-col gap-4 border-b border-stroke px-4 py-6 dark:border-dark-3 sm:flex-row sm:px-6 xl:px-9">
      ...
      <div className="mb-6 grid grid-cols-2 gap-6">
        <div className="col-span-2 rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card sm:col-span-1">
          ...
          <div className="grid grid-cols-5 border-t border-stroke px-4 py-4.5 dark:border-dark-3 md:px-6 2xl:px-7.5">
            <div className="col-span-3 sm:col-span-2 flex items-center px-2">
              <p className="font-medium">Giống cà phê</p>
            </div>
            <div className="col-span-2 sm:col-span-3 flex items-center px-2">
          ...
          {data?.effectedVarieties.map((variety, key) => (
            <Link key={key} href={`/coffee/${variety._id}`}>
              ...
              >
                <div className="col-span-3 sm:col-span-2 flex items-center gap-3 px-2">
                ...
                <div className="col-span-2 sm:col-span-3 flex items-center gap-3 px-2">
